 ...
 *
 * Custom error classes and error handling helpers for Gorgias MCP Server.
 */

/**
 * Base Gorgias API error
 */
 ...
 * Validation error
 */
export class ValidationError extends GorgiasApiError {
